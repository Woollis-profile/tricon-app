...
## Overview
A single-screen mobile **landing / welcome screen** for "TRICON Training," a strength-training app aimed at older athletes. It presents the brand logo, a tagline, and two primary entry actions (Create Account / Log In) over a dimmed gym photo. This is the first screen a logged-out user sees.
...
- **Wordlock** (centered over the mark, nudged `translateY(-19px)`):
  ...
  - **"TRAINING":** Oswald 500, `20px`, color **black `#1b1a18`**, `letter-spacing:0.46em`, sits directly under TRICON.
