...
const s = StyleSheet.create({
  ...
  svgOverlay: { position: 'absolute', alignItems: 'center', overflow: 'visible' },
  timeText: { fontFamily: 'Oswald_700Bold', fontSize: 22, color: C.text, lineHeight: 28 },
  leftLbl: { fontSize: 8, color: C.muted, letterSpacing: 1, marginTop: 2 },
  statsCol: { flex: 1, gap: 8 },
  roundBox: { backgroundColor: C.purple + '18', borderWidth: 1, borderColor: C.purple + '30', borderRadius: 10, paddingTop: 14, paddingBottom: 10, paddingHorizontal: 12, flex: 1, justifyContent: 'center', overflow: 'visible' },
  roundNum: { fontFamily: 'Oswald_700Bold', fontSize: 36, color: C.purple, lineHeight: 47 },
  ...
  endCard: { backgroundColor: C.purple + '12', borderWidth: 1, borderColor: C.purple + '30', borderRadius: 12, paddingTop: 14, paddingHorizontal: 16, paddingBottom: 16, alignItems: 'center', overflow: 'visible' },
  endIcon: { fontSize: 30, marginBottom: 6 },
  endTitle: { fontFamily: 'Oswald_400Regular', fontSize: 20, color: C.purple, letterSpacing: 1, lineHeight: 25 },
  endRounds: { fontFamily: 'Oswald_700Bold', fontSize: 40, color: C.text, marginTop: 4, lineHeight: 52 },
