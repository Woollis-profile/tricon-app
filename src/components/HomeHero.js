...
const s = StyleSheet.create({
  ...
  title1: { fontFamily: 'Oswald_700Bold', fontSize: 28, color: C.text, lineHeight: 26, letterSpacing: 1, marginBottom: 2 },
  title2: { fontFamily: 'Oswald_700Bold', fontSize: 28, lineHeight: 26, letterSpacing: 1, marginBottom: 14 },
