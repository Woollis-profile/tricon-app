...
const s = StyleSheet.create({
  ...
  restTitle: { fontFamily: 'Oswald_400Regular', fontSize: 16, color: C.text, letterSpacing: 1 },
  ...
  fridayCard: { borderWidth: 1, borderRadius: 14, padding: 14 },
  ...
  fridayCardTitle: { fontFamily: 'Oswald_700Bold', fontSize: 18, color: C.text, lineHeight: 18 },
  ...
  dayCard: { borderWidth: 1, borderRadius: 14, padding: 16, marginBottom: 12 },
  ...
  dayCardTitle: { fontFamily: 'Oswald_700Bold', fontSize: 24, color: C.text, lineHeight: 24 },
