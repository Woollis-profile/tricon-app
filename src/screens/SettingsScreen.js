...
const s = StyleSheet.create({
  ...
  sectionHeaderText: { fontSize: 10, letterSpacing: 1, fontWeight: '700' },
  row: { paddingVertical: 14, paddingHorizontal: 14, borderBottomWidth: 1 },
  rowLabel: { fontSize: 10, color: C.muted, letterSpacing: 1, marginBottom: 8 },
  ...
  rowNote: { fontSize: 10, color: C.muted, marginTop: 8, lineHeight: 15 },
  ...
  weekName: { fontSize: 12, color: C.text },
  weekDetail: { fontSize: 10, color: C.muted, marginTop: 1 },
  ...
  schedDay: { fontSize: 12, color: C.text, fontWeight: '600' },
  schedDetail: { fontSize: 10, color: C.muted, marginTop: 2 },
  schedDot: { width: 8, height: 8, borderRadius: 4 },
  dataText: { fontSize: 11, color: C.sub, lineHeight: 20 },
