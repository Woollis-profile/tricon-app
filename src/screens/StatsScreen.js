...
const s = StyleSheet.create({
  ...
  drillStat: { flex: 1, borderWidth: 1, borderRadius: 9, paddingTop: 16, paddingBottom: 11, paddingHorizontal: 8, alignItems: 'center', minHeight: 80, overflow: 'visible' },
  drillStatNum: { fontFamily: 'Oswald_700Bold', fontSize: 26, lineHeight: 34 },
