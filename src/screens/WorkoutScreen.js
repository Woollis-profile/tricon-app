...
const s = StyleSheet.create({
  ...
  // DONE
  doneContent: { flexGrow: 1, alignItems: 'center', justifyContent: 'center', padding: 24, paddingBottom: 100, overflow: 'visible' },
  doneIcon: { fontSize: 54, lineHeight: 70 },
  doneTitle: { fontFamily: 'Oswald_700Bold', fontSize: 25, color: C.text, marginTop: 12, textAlign: 'center', letterSpacing: 0.5, lineHeight: 33 },
  doneMeta: { color: C.muted, fontSize: 12, marginTop: 7 },
  amrapResult: { borderWidth: 1, borderRadius: 12, paddingTop: 14, paddingHorizontal: 20, paddingBottom: 20, marginTop: 16, width: '100%', alignItems: 'center', overflow: 'visible' },
  ...
  splitItem: { flex: 1, alignItems: 'center', backgroundColor: 'rgba(76,175,125,0.08)', borderWidth: 1, borderColor: 'rgba(76,175,125,0.2)', borderRadius: 8, paddingTop: 14, paddingBottom: 9, paddingHorizontal: 4, overflow: 'visible' },
  splitTime: { fontFamily: 'Oswald_700Bold', fontSize: 19, color: C.green, lineHeight: 24 },
  ...
  summaryItem: { flex: 1, alignItems: 'center', paddingTop: 14, overflow: 'visible' },
  summaryNum: { fontFamily: 'Oswald_700Bold', fontSize: 22, lineHeight: 28 },
  ...
  warmupCard: { backgroundColor: C.card, borderRadius: 12, borderWidth: 1, borderColor: C.border },
  ...
  setupCard: { backgroundColor: C.card, borderWidth: 1, borderRadius: 12 },
  ...
  setupRow: { paddingVertical: 12, paddingHorizontal: 14, flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: C.border, overflow: 'visible' },
  setupLabel: { fontSize: 10, color: C.muted, marginBottom: 3 },
  setupVal: { fontFamily: 'Oswald_700Bold', fontSize: 24, color: C.text, lineHeight: 31 },
  ...
  roundPreviewCard: { backgroundColor: '#0d1117', borderWidth: 1, borderRadius: 12 },
  ...
  flowCard: { backgroundColor: '#0d1117', borderWidth: 1, borderRadius: 12 },
